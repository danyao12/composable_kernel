...
#include "ck/tensor_operation/gpu/grid/gridwise_batched_gemm_softmax_gemm_xdl_cshuffle_v3.hpp"
...
struct DeviceBatchedGemmSoftmaxGemmPermute_Xdl_CShuffle_v2
#if 0
...
#endif
{
    ...
    using DeviceOp = DeviceBatchedGemmSoftmaxGemmPermute_Xdl_CShuffle_v2;
    ...
    */
    ...
    // template <typename YGridDesc_M_O, typename Number>
    // static auto MakeYGradGridDescriptor_O0_M_O1(const YGridDesc_M_O& ygrad_grid_desc_m_o,
    //                                             const Number& O1)
    // {
    //     const auto M = ygrad_grid_desc_m_o.GetLength(I0);
    //     const auto O = ygrad_grid_desc_m_o.GetLength(I1);
    ...
    //     return transform_tensor_descriptor(
    //         ygrad_grid_desc_m_o,
    //         make_tuple(make_unmerge_transform(make_tuple(M)), make_pass_through_transform(O0, O1)),
    //         make_tuple(Sequence<0>{}, Sequence<1>{}),
        ...
        Argument(
            ...
            : p_a_grid_{p_a_grid},
              ...
              ygrad_grid_desc_o0_m_o1_{
                  DeviceOp::MakeYGradGridDescriptor_O0_M_O1(c_gs_ms_gemm1ns_lengths, c_gs_ms_gemm1ns_strides)},
            //   ygrad_grid_desc_o0_m_o1_{
            //       DeviceOp::MakeYGradGridDescriptor_O0_M_O1(c_grid_desc_m_n_, Number<Y_O1>{})},
              // batch offsets
              a_grid_desc_g_m_k_{
    ...
    std::string GetTypeString() const // override
    {
        ...
        // clang-format off
        str << "DeviceBatchedGemmSoftmaxGemmPermute_Xdl_CShuffle_v2"
            << "<"
            << BlockSize << ", "
            << MPerBlock << ", "
            << NPerBlock << ", "
