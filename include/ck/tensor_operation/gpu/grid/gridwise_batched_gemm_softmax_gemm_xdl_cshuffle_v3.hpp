...
struct GridwiseBatchedGemmSoftmaxGemm_Xdl_CShuffle
{
    ...
    struct VGradGemmTile_N_O_M_
    {
        ...
        static constexpr index_t YGrad_O1     = 8;
        static constexpr index_t YGrad_O0     = Free1_O / YGrad_O1;
        static constexpr index_t YGrad_OLdsPad = 1;

        static_assert(Sum_M % MPerXdl == 0, "");

        static constexpr index_t YGrad_SrcVectorDim       = 2; // Free1_O dimension
        static constexpr index_t YGrad_SrcScalarPerVector = 8;
        ...
        static constexpr index_t GemmMPack =
            math::max(P_M1, MfmaSelector<DataType, MPerXdl, NPerXdl>::selected_mfma.k_per_blk);
        static constexpr index_t YGradM3 = GemmMPack;
        static constexpr index_t YGradM2 = XdlopsGemm<DataType, MPerXdl, NPerXdl, GemmMPack, false>{}.K0PerXdlops;
        static constexpr index_t YGradM1 = Sum_M / YGradM2 / YGradM3;
        static constexpr index_t YGradM0 = GemmMLoop;

        using YGrad_BlockSliceLengths = Sequence<YGrad_O0, Free1_M, YGrad_O1>;
        using YGrad_ThreadClusterLengths =
            Sequence<Free1_O / YGrad_SrcScalarPerVector,
                     BlockSize / (Free1_O / YGrad_SrcScalarPerVector),
                     1>;
        using YGrad_ThreadClusterArrangeOrder = Sequence<1, 0, 2>;
        using YGrad_SrcAccessOrder            = Sequence<1, 0, 2>;
        ...
        __host__ __device__ static constexpr auto GetYGradBlockDescriptor_O0_M_O1()
        {
            return make_naive_tensor_descriptor(
                make_tuple(Number<YGrad_O0>{}, Number<Free1_M>{}, Number<YGrad_O1>{}),
                make_tuple(
                    Number<Free1_M + YGrad_OLdsPad>{} * Number<YGrad_O1>{}, Number<YGrad_O1>{}, I1));
        }
    ...
    template <typename PBlockDesc_M0_N_M1>
    __host__ __device__ static constexpr auto
    MakeVGradGemmPMmaTileDescriptor_N0_N1_N2_M(const PBlockDesc_M0_N_M1&)
    {
        return MakeGemmMmaTileDescriptor_MN0_MN1_MN2_K<VGradGemmTile_N_O_M::GemmNRepeat, VGradGemmTile_N_O_M::GemmNWave, MPerXdl>(PBlockDesc_M0_N_M1{});
    }

    template <typename YGradBlockDesc_M0_O_M1>
    __host__ __device__ static constexpr auto
    MakeVGradGemmYGradMmaTileDescriptor_O0_O1_O2_M(const YGradBlockDesc_M0_O_M1&)
    {
        return MakeGemmMmaTileDescriptor_MN0_MN1_MN2_K<VGradGemmTile_N_O_M::GemmORepeat, 1, 1>(YGradBlockDesc_M0_O_M1{});
    }
    ...
    {
        const index_t gemm0_bytes_end = (SharedMemTrait::a_block_space_offset + 
    ...
    struct SharedMemTrait
    {
        ...
        static constexpr auto ygrad_block_desc_o0_m_o1 =
            VGradGemmTile_N_O_M::GetYGradBlockDescriptor_O0_M_O1();
        ...
        static constexpr auto ygrad_block_space_size_aligned = math::integer_least_multiple(
            ygrad_block_desc_o0_m_o1.GetElementSpaceSize(), max_lds_align);
        ...
        static constexpr auto a_block_space_offset     = ygrad_block_space_size_aligned.value;
        static constexpr auto b_block_space_offset     = ygrad_block_space_size_aligned.value + a_block_space_size_aligned.value;
        static constexpr auto b1_block_space_offset    = ygrad_block_space_size_aligned.value;
        static constexpr auto p_block_space_offset     = ygrad_block_space_size_aligned.value;
                               ...
                               const C0MatrixMask& c0_matrix_mask)
    {
        ...
        constexpr auto ygrad_block_desc_o0_m_o1 =
            VGradGemmTile_N_O_M::GetYGradBlockDescriptor_O0_M_O1();

        // ygrad matrix blockwise copy
        auto ygrad_blockwise_copy = ThreadGroupTensorSliceTransfer_v4r1<
            ...
            typename VGradGemmTile_N_O_M::YGrad_SrcAccessOrder,
            Sequence<1, 0, 2>,
            VGradGemmTile_N_O_M::YGrad_SrcVectorDim,
            2, // DstVectorDim
            VGradGemmTile_N_O_M::YGrad_SrcScalarPerVector,
            VGradGemmTile_N_O_M::YGrad_O1,
            1,
            1,
            true,
            true,
            1>(ygrad_grid_desc_o0_m_o1,
               make_multi_index(0, m_block_data_idx_on_grid, 0),
               tensor_operation::element_wise::PassThrough{},
        ...
        auto ygrad_block_buf = make_dynamic_buffer<AddressSpaceEnum::Lds>(
            ...
            ygrad_block_desc_o0_m_o1.GetElementSpaceSize());

        constexpr auto ygrad_block_desc_o0_o1_o2_m0_m1_m2_m3 = [&]() constexpr
        {
            constexpr auto ygrad_block_desc_o_m = transform_tensor_descriptor( //(64, 128)
                ygrad_block_desc_o0_m_o1,
                make_tuple(make_merge_transform_v3_division_mod(
                               make_tuple(VGradGemmTile_N_O_M::YGrad_O0, VGradGemmTile_N_O_M::YGrad_O1)), //(8, 8)
                           make_pass_through_transform(VGradGemmTile_N_O_M::Free1_M)), //128
                make_tuple(Sequence<0, 2>{}, Sequence<1>{}),
                make_tuple(Sequence<0>{}, Sequence<1>{}));

            return transform_tensor_descriptor(
                ygrad_block_desc_o_m,
                make_tuple(make_unmerge_transform(make_tuple(VGradGemmTile_N_O_M::GemmORepeat, VGradGemmTile_N_O_M::GemmOWave, NPerXdl)), //(1, 2, 32)
                           make_unmerge_transform(make_tuple(VGradGemmTile_N_O_M::YGradM0, VGradGemmTile_N_O_M::YGradM1, VGradGemmTile_N_O_M::YGradM2, VGradGemmTile_N_O_M::YGradM3))), //(2, 4, 2, 8)
                make_tuple(Sequence<0>{}, Sequence<1>{}),
                make_tuple(Sequence<0, 1, 2>{}, Sequence<3, 4, 5, 6>{}));
        }
        ();

        using YGradThreadSlice_O0_O1_O2_M0_M1_M2_M3 = Sequence<VGradGemmTile_N_O_M::GemmORepeat, 
                                                               1, 
                                                               1, 
                                                               1, 
                                                               VGradGemmTile_N_O_M::YGradM1, 
                                                               1, 
                                                               VGradGemmTile_N_O_M::YGradM3>;
        constexpr auto ygrad_thread_desc_o0_o1_o2_m0_m1_m2_m3 = make_naive_tensor_descriptor_packed(
                                                                    make_tuple(Number<VGradGemmTile_N_O_M::GemmORepeat>{}, 
                                                                               I1, 
                                                                               I1, 
                                                                               I1, 
                                                                               Number<VGradGemmTile_N_O_M::YGradM1>{}, 
                                                                               I1, 
                                                                               Number<VGradGemmTile_N_O_M::YGradM3>{}));
        constexpr auto ygrad_thread_desc_m0_o_m1 = [&]() constexpr
        {
            constexpr auto ygrad_thread_desc_o_m = transform_tensor_descriptor(
                ygrad_thread_desc_o0_o1_o2_m0_m1_m2_m3,
                make_tuple(make_merge_transform_v3_division_mod(
                               make_tuple(Number<VGradGemmTile_N_O_M::GemmORepeat>{}, I1, I1)),
                           make_merge_transform_v3_division_mod(
                               make_tuple(I1, Number<VGradGemmTile_N_O_M::YGradM1>{}, I1, Number<VGradGemmTile_N_O_M::YGradM3>{}))),
                make_tuple(Sequence<0, 1, 2>{}, Sequence<3, 4, 5, 6>{}),
                make_tuple(Sequence<0>{}, Sequence<1>{}));

            return transform_tensor_descriptor(
                ygrad_thread_desc_o_m,
                make_tuple(make_pass_through_transform(Number<VGradGemmTile_N_O_M::GemmORepeat>{}),
                           make_unmerge_transform(make_tuple(Number<VGradGemmTile_N_O_M::YGradM1>{}, Number<VGradGemmTile_N_O_M::YGradM3>{}))),
                make_tuple(Sequence<0>{}, Sequence<1>{}),
                make_tuple(Sequence<1>{}, Sequence<0, 2>{}));
        }
        ();

        auto ygrad_thread_buf = make_static_buffer<AddressSpaceEnum::Vgpr, DataType>(
            ygrad_thread_desc_o0_o1_o2_m0_m1_m2_m3.GetElementSpaceSize());
        ...
        auto vgrad_blockwise_gemm =
            ...
            decltype(ygrad_thread_desc_m0_o_m1),
            decltype(MakeVGradGemmPMmaTileDescriptor_N0_N1_N2_M(p_block_desc_m0_n_m1)),
            decltype(MakeVGradGemmYGradMmaTileDescriptor_O0_O1_O2_M(ygrad_thread_desc_m0_o_m1)),
            NPerBlock,
            Gemm1NPerBlock,
            VGradGemmTile_N_O_M::Sum_M,
            MPerXdl,
            NPerXdl,
            ...
            true,       // TransposeC
            VGradGemmTile_N_O_M::GemmMPack * XdlopsGemm<DataType, MPerXdl, NPerXdl, VGradGemmTile_N_O_M::GemmMPack, false>{}.K0PerXdlops,
            VGradGemmTile_N_O_M::GemmMPack>{
            1,
            make_tuple(0, 0, 0, 0)};
        ...
        auto ygrad_thread_copy_lds_to_vgpr =
            ThreadwiseTensorSliceTransfer_v2<DataType,
                                             DataType,
                                             decltype(ygrad_block_desc_o0_o1_o2_m0_m1_m2_m3),
                                             decltype(ygrad_thread_desc_o0_o1_o2_m0_m1_m2_m3),
                                             YGradThreadSlice_O0_O1_O2_M0_M1_M2_M3,
                                             Sequence<0, 1, 2, 3, 4, 5, 6>,
                                             6,
                                             1,
                                             1,
                                             true>{
                ygrad_block_desc_o0_o1_o2_m0_m1_m2_m3,
                make_multi_index(0,                                                       // orepeat
                                 ygrad_thread_origin[I1],                                 // owave
                                 ygrad_thread_origin[I2],                                 // nperxdl
                                 0,                                                       // m0
                                 0,                                                       // m1
                                 ygrad_thread_origin[I3] / VGradGemmTile_N_O_M::GemmMPack,// m2
                                 0)};                                                     // m3

        constexpr auto ygrad_block_slice_copy_step =
            make_multi_index(0, 0, 0, 1, 0, 0, 0);
        constexpr auto ygrad_block_reset_copy_step =
            make_multi_index(0, 0, 0, -VGradGemmTile_N_O_M::YGradM0, 0, 0, 0);
        ...
        // load VGrad Gemm B
        ygrad_blockwise_copy.Run(ygrad_grid_desc_o0_m_o1, ygrad_grid_buf, ygrad_block_desc_o0_m_o1, ygrad_block_buf, I0);
        ...
        do
        {
            ...
            static_for<0, num_vgrad_gemm_loop, 1>{}([&](auto vgrad_gemm_loop_idx) { // gemm dV
                ...
                ygrad_thread_copy_lds_to_vgpr.Run(ygrad_block_desc_o0_o1_o2_m0_m1_m2_m3,
                                                  ygrad_block_buf,
                                                  ygrad_thread_desc_o0_o1_o2_m0_m1_m2_m3,
                                                  make_tuple(I0, I0, I0, I0, I0, I0, I0),
                                                  ygrad_thread_buf);

                ygrad_thread_copy_lds_to_vgpr.MoveSrcSliceWindow(ygrad_block_desc_o0_o1_o2_m0_m1_m2_m3,
                ...
                if (hipBlockIdx_x == 0)
                {
                    debug::print_shared(ygrad_block_buf.p_data_,
                                        index_t(ygrad_block_desc_o0_m_o1.GetElementSpaceSize()));
                }
#endif

                block_sync_lds(); // sync before read
                vgrad_blockwise_gemm.Run(p_block_buf, ygrad_thread_buf, vgrad_acc_thread_buf);
